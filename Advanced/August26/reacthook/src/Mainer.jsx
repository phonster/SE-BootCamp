                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            ...
                            <div className="modal-body ph-tab-bkgrd">
                                ...
                                <div className={`collapse ${isCollapsed?'':'show'}`} id="collapseMtn">
                            ...
                            <div className="modal-footer">
                                ...
                                <button type="button" className="btn btn-primary" onClick={handleCollapse} mynote="remove bs toggle attributes. Control via react">Add to Cart</button>
                            </div>
                        </div>
                    </div>
                </div>
